...
const Seat = ({seats, onSeatSelect, selectedSeats}: {seats: [seat_id[]]; onSeatSelect: (seat_id: number) => void; selectedSeats: number[]}) => {
  console.log('this is seats', seats);
    return (
                                    ...
                                    return (
                                        <TouchableOpacity
                                            ...
                                            onPress={()=>onSeatSelect(s.seat_id)}>
                                                <Image
                                                source={selectedSeats?.includes(s?.seat_id)
                                                    ? SelectedIcon
                                                    : s.booked
                                                    ? BookedIcon
                                                    : AvailableIcon
