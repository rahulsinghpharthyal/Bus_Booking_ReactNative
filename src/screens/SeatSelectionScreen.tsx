...
import { socket } from '../service/config';
...
const SeatSelectionScreen = () => {
    ...
    const handleVerifyPayment = async (result: {
            ...
            console.log("Joined WS room:", paymentId);
            ...
            socket.on("payment_status", (data: {
                ...
                console.log("WebSocket Payment Status:", data);

                if (data.success) {
                    console.log("Payment verified by Webhook via WebSocket");
                    ...
                    console.log("Payment Failed (WebSocket)");
